...
<body>
	<div id="mainWrapper">
		...
		<div id="header">
			<div id="globalTitle">
				<a href="/jch">Prediction of One Bond Coupling Constants - 1JCH</a>
			</div>
			<div id="localTitle">
				&nbsp; <a style="float: right; padding-right: 10px;" href="/jch"><img
				...
				<tr height="25%">
					...
					<td width="50%">
						<div id="apps" align="left" style="">
							<form action="/jch/PredictionHandler" method="post"
