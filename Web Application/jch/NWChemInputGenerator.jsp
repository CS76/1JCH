...
<body>
	<div id="mainWrapper">
		...
		<div id="header">
			<div id="globalTitle"><a href="/jch">Prediction of One Bond Coupling Constants - 1JCH</a> </div>
			<div id="localTitle">
				<p>NWChem Input Generator <a style="float: right; padding-right: 10px;" href="/jch"><img alt="Home" src="images/home.png" height=" 20px;" width="20px;"></a><a style="float: right; padding-right: 10px;" href="/jch/PredictionInput.jsp"><img alt="Home" src="images/process.png" height=" 20px;" width="20px;"></a></p> 
			</div>
		</div>
		<div id="dataContainer" style="height: 180%">
			<form method="post" action="/jch/NWChemInputHandler"
